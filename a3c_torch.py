...
from models.utilities_torch import v_wrap, set_init, push_and_pull, record
...
class Worker(mp.Process):
    def __init__(self, gnet, opt, global_ep, global_ep_r, res_queue, name):
        ...
        self.env = rl_energy_env.EnergyEnv(battery_copy, resource, result_df)
    ...
    def run(self):
        ...
        while self.g_ep.value < MAX_EP:
            ...
            for t in range(MAX_EP_STEP):
                ...
                buffer_a.append(a)
                buffer_s.append(s)
                buffer_r.append((r+15)/35)    # normalize
...
if __name__ == "__main__":
    ...
    fig_dir = current_path + '/plots/' + os.environ['SLURM_JOB_ID'] + '.jpg'
    fig.savefig(fig_dir)

    network_dir = current_path + '/networks/' + os.environ['SLURM_JOB_ID'] + '.net'
    torch.save(gnet, network_dir)
